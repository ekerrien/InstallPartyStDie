...
Messages.user_cert_missing = "fichier de certificat personnel non " \
    "trouvé"
Config.instname = "Université de Lorraine"
Config.profilename = "eduroam et Personnels Univ-Lorraine"
Config.url = "http://u2l.fr/wifi"
Config.email = "	dn-wifi-gest@univ-lorraine.fr"
Config.title = "eduroam CAT"
Config.server_match = "radius.univ-lorraine.fr"
...
Config.init_confirmation = "Cet installateur ne fonctionnera " \
    ...
    "{1}."
Config.user_realm = "univ-lorraine.fr"
Config.ssids = ['eduroam', 'Personnels Univ-Lorraine']
Config.del_ssids = []
Config.servers = ['DNS:radius.univ-lorraine.fr']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@univ-lorraine.fr"
Config.tou = ""
